...
with st.sidebar:
    ...
    if not st.session_state.loaded:
        ...
        <div class="stat-row">
            ...
            <div class="stat-card">
                <div class="stat-num">{vecs}</div>
                <div class="stat-label">Vectors</div>
            </div>
            <div class="stat-card">
                <div class="stat-num">{len(st.session_state.chat)//2}</div>
...
if not st.session_state.loaded:
    ...
    <div class="boot-screen">
        ...
        <div class="boot-steps">
            ...
            <div><span>02</span>Wait ~30 seconds on first run</div>
...
with col_hint:
    st.markdown(
        '<div class="send-hint" style="padding-top:8px;">Vowel · DeepSeek Coder via HuggingFace · persistent memory</div>',
        unsafe_allow_html=True
    )
